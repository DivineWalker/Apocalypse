...
65 is reached, their health will decrease by 0.5 each year leading to death. The grid will print out each time a move is made, a human
is spawned, another virus appeards, a human is attacked or infected and dying. The user will be informed of all changed either shown 
on the board itself or displayed below the board
